...
def setup_product():
    ...
    import ebc.monitoramento
    zcml.load_config('configure.zcml', ebc.monitoramento)
    ...
    ztc.installPackage('ebc.monitoramento')
...
setup_product()
ptc.setupPloneSite(products=['ebc.monitoramento'])
